...
window.CURRICULO = {
  ...
  editalItems: (function(){
    ...
    return [
      ...
      { bloco:"Língua Portuguesa", item:"Coordenação e subordinação", aulas:[[PT,6],[PT,7]] },
      ...
      { bloco:"Administração da Produção e Compras", item:"Gestão de Compras", aulas:[[MAT,2]] },
      { bloco:"Administração da Produção e Compras", item:"Gestão de Estoques: MRP, Ponto de Ressuprimento, Lote Econômico de Compra, Just in Time, RFID, Código de Barras e UID", aulas:[[MAT,1],[MAT,3],[MAT,4],[MAT,5]] },
      ...
      // Contratação
      { bloco:"Contratação", item:"Lei 13.303/2016, artigos 28 a 91 (Estatuto Jurídico da empresa pública)", aulas:[[LEG,0]] },
      { bloco:"Contratação", item:"Lei Complementar 123/2006, artigos 42 a 49 (Estatuto da microempresa e EPP)", aulas:[[LEG,1]] },
      // Gerenciamento de Projetos
      { bloco:"Gerenciamento de Projetos", item:"Ciclo de Vida do projeto", aulas:[[ADM,7]] },
      ...
      { bloco:"Conflitos e Negociação", item:"Conflitos", aulas:[[ADM,15]] },
      { bloco:"Conflitos e Negociação", item:"Negociação", aulas:[[ADM,16]] },
      ...
      { bloco:"Administração Mercadológica", item:"Mídias digitais, Plataformização", aulas:[[ADM,17],[ADM,18]] },
      // Contabilidade
